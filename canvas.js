window.addEventListener('load', () => {
    ...
    let coordinate1 = canvas.width / 8;
    let coordinate2 = canvas.height / 2;

    function redraw() {
        resetCanvas();
        ctx.drawImage(img, coordinate1 - 28, coordinate2 - 15, imgWidth, imgHeight)
    }
    ...
    function mouseOn(e) {
        ...
        $('#number').html(Math.round((0.9 + ((5 - 0.9) / 100)*percent) * 100) / 100 + ' მლრდ')
    }
